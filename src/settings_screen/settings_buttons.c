...
{
    char *new_text = malloc(5);

    if ((settings->main_volume == 100 && mode == 1) || (settings->main_volume == 0 && mode == 0)) {
        free(new_text);
        return;
    }
    if (mode == 1) {
...
void check_plus_button(game_t *game, settings_screen_t *settings, sfVector2f pos)
{
...
void check_minus_button(game_t *game, settings_screen_t *settings, sfVector2f pos)
{
...
void check_cross_button(game_t *game, settings_screen_t *settings, sfVector2f pos)
{
